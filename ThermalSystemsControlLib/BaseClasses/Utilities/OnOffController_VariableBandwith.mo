...
model OnOffController_VariableBandwith
  ...
  Modelica.Blocks.Interfaces.RealInput u "Connector of Real input signal used as measurement signal"
                                                                annotation (
  ...
  Modelica.Blocks.Interfaces.RealInput bandwidth annotation (Placement(transformation(extent={{-140,20},{-100,-20}})));
initial equation
  pre(y) = pre_y_start;
equation
...
end OnOffController_VariableBandwith;
