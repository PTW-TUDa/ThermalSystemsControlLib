...
partial model ActuatorContinuous_LocalControlMode
  ...
  Interfaces.localSetParametersControlMode_FMUConnector localSetParameters_FMUConnector annotation (Placement(transformation(extent={{-100,-100},{-80,-80}})));
...
equation
  connect(localSetParameters_FMUConnector.localSetParameters1, selectLocalControlMode.localSetParameters1) annotation (Line(points={{-79,-90},{-75,-90},{-75,-81}}, color={0,0,0}));
