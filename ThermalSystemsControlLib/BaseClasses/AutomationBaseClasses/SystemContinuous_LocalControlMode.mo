...
partial model SystemContinuous_LocalControlMode
...
equation
  connect(systemFlowControl.systemState, systemState.systemState1) annotation (Line(points={{-21,81},{-21,90}}, color={0,0,0}));
...
Automation base model for a continuous system model including a local control mode <a href=\"ThermalSystemsControlLib.UsersGuide.References\">[BORS23]</a>.
</html>"));
end SystemContinuous_LocalControlMode;
