...
equation
  ...
  connect(twoWayValve_Physical.fOperatingPoint, gain.u) annotation (Line(points={{66,11},{66,20},{42,20}}, color={0,0,127}));
  connect(gain.y, selectSetPoint.fOperatingPoint) annotation (Line(points={{19,20},{0,20},{0,0},{-70,0},{-70,18}}, color={0,0,127}));
