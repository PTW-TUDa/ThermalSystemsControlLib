...
equation
  ...
  connect(fThermalPowerExternal, controlValve.fThermalPowerExternal) annotation (Line(points={{0,-120},{0,-80},{-10,-80},{-10,-62}}, color={0,0,127}));
  ...
  connect(twoWayValve_Physical.fOperatingPoint, selectSetPoint.fOperatingPoint) annotation (Line(points={{64,11},{64,20},{0,20},{0,0},{-70,0},{-70,18}}, color={0,0,127}));
