...
//connections
  ...
  connect(abs2.y, PID_ThermalPower.u_m) annotation (Line(points={{8.88178e-16,-39},{0,-39},{0,-12}},
                                                                                              color={0,0,127}));
  connect(abs2.u, fThermalPowerExternal) annotation (Line(points={{-6.66134e-16,-62},{0,-62},{0,-120}}, color={0,0,127}));
  connect(bSetStatusOn, switch.u2) annotation (Line(points={{-120,90},{40,90},{40,0},{58,0}}, color={255,0,255}));
  connect(abs1.u, fSetPoint) annotation (Line(points={{-62,0},{-120,0}}, color={0,0,127}));
