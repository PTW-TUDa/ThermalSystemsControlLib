within ThermalSystemsControlLib.Components.HybridCooler.Methods;
model ControlHybridCooler
...
//connections
  ...
  connect(PID_FeedTemperature.u_m, fSetPoint) annotation (Line(points={{0,12},{0,20},{-60,20},{-60,0},{-120,0}}, color={0,0,127}));
  connect(PID_FeedTemperature.u_s, fTemperatureExternal) annotation (Line(points={{-12,0},{-20,0},{-20,-60},{0,-60},{0,-120}}, color={0,0,127}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(coordinateSystem(preserveAspectRatio=false)),
    Documentation(info="<html>
<p>Control method for hybrid coolers.</p>
<p>nControl = 1: Feed temperature.</p>
<p>else: fSetPoint controls relative power.</p>
</html>"));
end ControlHybridCooler;
