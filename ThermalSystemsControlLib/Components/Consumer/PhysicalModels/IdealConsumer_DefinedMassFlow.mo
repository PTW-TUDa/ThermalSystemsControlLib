...
model IdealConsumer_DefinedMassFlow
  ...
  Modelica.Blocks.Logical.Switch switch1 annotation (Placement(transformation(
        ...
        rotation=90,
        origin={0,-46})));
  Modelica.Blocks.Logical.GreaterThreshold greaterThreshold(threshold=3) annotation (Placement(transformation(extent={{-50,-90},{-30,-70}})));
  ...
  Modelica.Blocks.Sources.RealExpression volume_Temperature(y=volume.medium.T) annotation (Placement(transformation(extent={{-84,-90},{-64,-70}})));
equation
  ...
  connect(greaterThreshold.y, switch1.u2) annotation (Line(points={{-29,-80},{-16,-80},{-16,-68},{0,-68},{0,-58}},
                                                                                               color={255,0,255}));
  ...
  connect(m_flow_in, idealSource_simple.m_flow_in) annotation (Line(points={{-100,-120},{-100,-28},{-60,-28},{-60,-12}}, color={0,0,127}));
  connect(volume_Temperature.y, greaterThreshold.u) annotation (Line(points={{-63,-80},{-52,-80}}, color={0,0,127}));
