...
equation
  ...
  connect(layeredStorage_Physical_test.port_charge, port_a) annotation (Line(points={{46,-9.6},{46,-86},{100,-86},{100,-100}}, color={0,127,255}));
  connect(layeredStorage_Physical_test.port_discharge, port_a) annotation (Line(points={{45.8,-5},{45.8,-86},{100,-86},{100,-100}}, color={0,127,255}));
