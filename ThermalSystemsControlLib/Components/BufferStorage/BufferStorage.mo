...
equation
  ...
  connect(WMZx01.port_b, BufferStorage.port_a) annotation (Line(points={{80,-40},{80,0}}, color={0,127,255}));
  connect(temperature.port_a, BufferStorage.port_b) annotation (Line(points={{80,60},{80,20}}, color={0,127,255}));
  connect(temperature.port_b, port_b) annotation (Line(points={{80,80},{80,100},{100,100}}, color={0,127,255}));
