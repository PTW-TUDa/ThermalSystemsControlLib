...
model BufferStorage
  ...
  HeatMeter.HeatMeter WMZx01(redeclare package Medium = Medium) annotation (Placement(transformation(extent={{60,80},{80,60}})));
...
equation
  ...
  connect(WMZx01.port_a, port_b) annotation (Line(points={{80,80},{80,100},{100,100}}, color={0,127,255}));
  connect(WMZx01.port_b, BufferStorage.port_b) annotation (Line(points={{80,60},{80,20}}, color={0,127,255}));
  connect(BufferStorage.port_a, temperature.port_a) annotation (Line(points={{80,0},{80,-40}}, color={0,127,255}));
  connect(temperature.port_b, port_a) annotation (Line(points={{80,-60},{80,-100},{100,-100}}, color={0,127,255}));
  connect(temperature.T, WMZx01.fFeedTemperature) annotation (Line(points={{91,-50},{100,-50},{100,70},{82,70}}, color={0,0,127}));
