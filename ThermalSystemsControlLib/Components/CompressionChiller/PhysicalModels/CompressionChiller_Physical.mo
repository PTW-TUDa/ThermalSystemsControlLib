...
model CompressionChiller_Physical
  ...
  ThermalSystemsControlLib.BaseClasses.Utilities.ZeroLimiter zeroLimiter(u_min=deviceData.u_min) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={0,78})));
  BaseClasses.FluidBaseClasses.ConditionCheck_TwoTemperatures conditionCheck annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={0,50})));
...
equation
  ...
  connect(zeroLimiter.y, conditionCheck.fSetPoint) annotation (Line(points={{0,67},{1.77636e-15,67},{1.77636e-15,61}},
                                                                                                   color={0,0,127}));
  connect(conditionCheck.fSetPointInternal, firstOrder.u) annotation (Line(points={{-5,39},{-5,38},{0,38},{0,22},{2.22045e-15,22}}, color={0,0,127}));
  ...
  connect(conditionCheck.bStatusOn, bStatusOn) annotation (Line(points={{5,39},{40,39},{40,80},{110,80}}, color={255,0,255}));
  ...
  connect(Table_f_Pel_partLoad1.u, firstOrder.y) annotation (Line(points={{-38,90},{-20,90},{-20,-1},{0,-1}}, color={0,0,127}));
  ...
  connect(gain_P_th_nom1.y, signCorrect_cool1.u) annotation (Line(points={{-78.6,30},{-80,30},{-80,-50},{-54.8,-50}}, color={0,0,127}));
