...
equation
  ...
  connect(temperature.T, controlChiller.fTemperatureExternal) annotation (Line(points={{59,50},{20,50},{20,-20},{-10,-20},{-10,-62}}, color={0,0,127}));
  connect(compressionChiller_Physical.port_a1, port_a1) annotation (Line(points={{80,10},{80,40},{102,40}}, color={0,127,255}));
  connect(compressionChiller_Physical.port_b1, port_b1) annotation (Line(points={{80,-10},{80,-40},{100,-40}}, color={0,127,255}));
