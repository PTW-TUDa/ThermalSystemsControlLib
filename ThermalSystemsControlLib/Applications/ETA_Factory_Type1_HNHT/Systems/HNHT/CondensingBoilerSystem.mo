...
model CondensingBoilerSystem
  ...
  Components.GasBoiler.GasBoiler CondensingBoiler(
    ...
    k=5,
    yMin=0.5,
    redeclare ThermalSystemsControlLib.Applications.ETA_Factory_Type1_HNHT.Records.ViessmannVitodens200
  ...
  Components.Valves.TwoWayValve SV331(redeclare ThermalSystemsControlLib.Applications.ETA_Factory_Type1_HNHT.Records.Belimo_R2032_S2
