...
model CHP2System
  ...
  Components.CombinedHeatPower.CHP_Type1 CHP(
    ...
    k=5,
    yMin=0.5,
    redeclare ThermalSystemsControlLib.Applications.ETA_Factory_Type1_HNHT.Records.ViessmannVitobloc200_EM_9_2
                                                                                                          deviceData) annotation (Placement(transformation(extent={{60,-8},{80,12}})));
  Components.Valves.ThreeWayValve RV32x(
    k=5,
    yMin=0.5,
    redeclare ThermalSystemsControlLib.Applications.ETA_Factory_Type1_HNHT.Records.Belimo_R2032_S2_ThreeWay
  ...
  Components.Valves.TwoWayValve SV32x(redeclare ThermalSystemsControlLib.Applications.ETA_Factory_Type1_HNHT.Records.Belimo_R2032_S2
  ...
  Modelica.Blocks.Sources.IntegerExpression integerExpression2(y=2) annotation (Placement(transformation(extent={{42,-56},{52,-44}})));
...
equation
  ...
  connect(integerExpression.y, CHP.nControlModeAutomatic) annotation (Line(points={{52.5,-11},{58,-11},{58,-3}},
                                                                                                              color={255,127,0}));
  ...
  connect(integerExpression2.y,RV32x. nControlModeAutomatic) annotation (Line(points={{52.5,-50},{54,-50},{54,-36},{56,-36},{56,-35},{58,-35}},
                                                                                                                                             color={255,127,0}));
