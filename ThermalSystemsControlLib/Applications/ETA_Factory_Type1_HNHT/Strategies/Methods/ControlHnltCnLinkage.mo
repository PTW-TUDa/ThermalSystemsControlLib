...
model ControlHnltCnLinkage
  ...
  input ThermalSystemsControlLib.Applications.ETA_Factory_Type1_HNHT.ThermalNetworks.Interfaces.thermalNetworkState hnltState annotation (Placement(transformation(extent={{-100,-120},{-80,-100}})));
...
equation
  ...
  Controller_HeatPump_CN.u = hnltState.fUpperTemperature;
