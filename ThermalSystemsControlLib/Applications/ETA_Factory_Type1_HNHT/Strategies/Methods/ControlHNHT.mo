...
model ControlHNHT
  ...
  parameter Real fOffset_TargetTemperature_CondensingBoiler=1;
  Real fOffset_TargetTemperature_CHP1;
  Real fOffset_TargetTemperature_CHP2;
  Boolean bTrigger_CHP1;
  Boolean bTrigger_CHP2;

  output ThermalSystemsControlLib.Applications.ETA_Factory_Type1_HNHT.ThermalNetworks.Interfaces.hnhtControl hnhtControl annotation (Placement(transformation(extent={{40,-120},{60,-100}})));
  input ThermalSystemsControlLib.Applications.ETA_Factory_Type1_HNHT.ThermalNetworks.Interfaces.thermalNetworkState hnhtState annotation (Placement(transformation(extent={{-60,-120},{-40,-100}})));
...
equation
  ...
  Controller_CHP1_UpperTemperature.reference = strategyState.fTargetTemperature_HNHT - fOffset_TargetTemperature_CHP1;
  Controller_CHP1_LowerTemperature.reference = strategyState.fTargetTemperature_HNHT - fOffset_TargetTemperature_CHP1;
  ...
  Controller_CHP2_UpperTemperature.reference = strategyState.fTargetTemperature_HNHT - fOffset_TargetTemperature_CHP2;
  Controller_CHP2_LowerTemperature.reference = strategyState.fTargetTemperature_HNHT - fOffset_TargetTemperature_CHP2;
  ...
  Controller_Buffer_VSI_Unloading.reference = strategyState.fTargetTemperature_HNHT;
