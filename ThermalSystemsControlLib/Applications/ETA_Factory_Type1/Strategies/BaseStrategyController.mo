within ThermalSystemsControlLib.Applications.ETA_Factory_Type1.Strategies;
model BaseStrategyController
  ...
  output ThermalSystemsControlLib.Applications.ETA_Factory_Type1.ThermalNetworks.Interfaces.hnhtControl hnhtControl annotation (Placement(transformation(extent={{-150,-120},{-130,-100}})));
  output ThermalSystemsControlLib.Applications.ETA_Factory_Type1.ThermalNetworks.Interfaces.hnhtHnltLinkageControl hnhtHnltLinkageControl annotation (Placement(transformation(extent={{-70,-120},{-50,-100}})));
  input ThermalSystemsControlLib.Applications.ETA_Factory_Type1.ThermalNetworks.Interfaces.thermalNetworkState hnhtState annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-100,-110})));
  input ThermalSystemsControlLib.Applications.ETA_Factory_Type1.ThermalNetworks.Interfaces.thermalNetworkState hnltState annotation (Placement(transformation(extent={{-30,-120},{-10,-100}})));
