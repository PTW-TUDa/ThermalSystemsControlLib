...
model ControlHnltCnLinkage
  ...
  input ThermalSystemsControlLib.Applications.ETA_Factory_Type1.ThermalNetworks.Interfaces.thermalNetworkState hnltState annotation (Placement(transformation(extent={{-100,-120},{-80,-100}})));
