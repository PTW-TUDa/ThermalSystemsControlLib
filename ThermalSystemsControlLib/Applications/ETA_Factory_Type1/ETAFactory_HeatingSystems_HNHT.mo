...
model ETAFactory_HeatingSystems_HNHT
  ...
  ThermalNetworks.Ambient Ambient annotation (Placement(transformation(
        ...
        rotation=270,
        origin={-10,-30})));
  Strategies.BaseStrategyController_HNHT BaseStrategyController annotation (Placement(transformation(extent={{-20,40},{0,60}})));
equation
...
end ETAFactory_HeatingSystems_HNHT;
