within ThermalSystemsControlLib.Applications.ETA_Factory_Type1.Systems.CN;
...
equation
  ...
  connect(HeatExchanger4.port_a1, PUx05.port_b) annotation (Line(points={{100,8},{100,0}}, color={0,127,255}));
  connect(HeatExchanger4.port_b1, WMZx05.port_a) annotation (Line(points={{100,28},{100,40}}, color={0,127,255}));
  ...
  connect(pipe2.port_b, HeatExchanger4.port_a2) annotation (Line(points={{120,40},{108,40},{108,28}}, color={0,127,255}));
  ...
  connect(HeatExchanger4.port_b2, PU7x0.port_b) annotation (Line(points={{108,8},{108,0},{140,0}}, color={0,127,255}));
  connect(boundary.ports[1], WMZ7x0.port_a) annotation (Line(points={{200,70},{200,40},{180,40}}, color={0,127,255}));
  connect(temperature1.port, HeatExchanger4.port_a1) annotation (Line(points={{88,10},{88,8},{100,8}}, color={0,127,255}));
