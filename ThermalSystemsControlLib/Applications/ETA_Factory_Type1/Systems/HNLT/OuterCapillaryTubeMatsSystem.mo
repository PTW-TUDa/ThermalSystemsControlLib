...
model OuterCapillaryTubeMatsSystem
  ...
  Components.Valves.TwoWayValve SV235(redeclare package Medium = Medium, redeclare ThermalSystemsControlLib.Applications.ETA_Factory_Type1.Records.Belimo_R2032_S2
