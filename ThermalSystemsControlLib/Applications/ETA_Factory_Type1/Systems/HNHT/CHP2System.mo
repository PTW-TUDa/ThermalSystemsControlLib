...
model CHP2System
  ...
  Components.CombinedHeatPower.CHP_Type1 CHP(
    ...
    k=5,
    yMin=0.5,
    redeclare ThermalSystemsControlLib.Applications.ETA_Factory_Type1.Records.ViessmannVitobloc200_EM_9_2 deviceData) annotation (Placement(transformation(extent={{60,-8},{80,12}})));
  ...
  Components.Valves.TwoWayValve SV32x(redeclare ThermalSystemsControlLib.Applications.ETA_Factory_Type1.Records.Belimo_R2032_S2
