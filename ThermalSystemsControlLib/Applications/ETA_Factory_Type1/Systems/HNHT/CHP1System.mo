...
model CHP1System
  ...
  Components.CombinedHeatPower.CHP_Type1 CHP(
    ...
    k=5,
    yMin=0.5,
    redeclare ThermalSystemsControlLib.Applications.ETA_Factory_Type1.Records.ViessmannVitobloc200_EM_6_15 deviceData) annotation (Placement(transformation(extent={{60,-8},{80,12}})));
