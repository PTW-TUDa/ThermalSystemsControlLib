...
model ETAFactory_HeatingSystems
  ...
  ThermalSystemsControlLib.Applications.ETA_Factory_Type1.ThermalNetworks.HNHT HNHT(T_start_ActiveStorage=323.15) annotation (Placement(transformation(extent={{-82,0},{-62,20}})));
  ThermalSystemsControlLib.Applications.ETA_Factory_Type1.ThermalNetworks.HNHT_HNLT HNHT_HNLT annotation (Placement(transformation(extent={{-40,0},{-20,20}})));
  ThermalSystemsControlLib.Applications.ETA_Factory_Type1.ThermalNetworks.HNLT HNLT(T_start_ActiveStorage=308.15) annotation (Placement(transformation(extent={{0,0},{20,20}})));
  ThermalSystemsControlLib.Applications.ETA_Factory_Type1.Strategies.BaseStrategyController Strategy annotation (Placement(transformation(extent={{0,60},{20,80}})));
  ...
  ThermalNetworks.CN CN(T_start_ActiveStorage=288.15)
