...
model HDOptimizationControlCN
  ...
  Modelica.Blocks.Logical.OnOffController AKM_Controller(bandwidth=5) annotation (Placement(transformation(extent={{0,20},{20,40}})));
  Thermalnetworks.Interfaces.control_CN_Output control_CN annotation (Placement(transformation(extent={{60,-120},{80,-100}})));

equation
  AKM_Controller.u = localState_CN.fMidTemperature;
  AKM_Controller.reference = strategyState.fTargetTemperature_HNLT;
  control_CN.bSetStatusOn_AKM =AKM_Controller.y;
