...
model ControlCN
      ...
      parameter Real fOffset_TargetTemperature_eChiller = 2;
  ...
  Modelica.Blocks.Logical.OnOffController Controller_eChiller(bandwidth=4) annotation (Placement(transformation(extent={{-80,60},{-60,80}})));
