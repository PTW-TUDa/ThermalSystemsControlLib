within ThermalSystemsControlLib.Applications.ETA_Factory.Strategies.Strategy_NoStorages;
model StrategyController_NoStorages
...
end StrategyController_NoStorages;
