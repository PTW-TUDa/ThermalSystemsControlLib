within ThermalSystemsControlLib.Applications.ETA_Factory.Strategies.Strategy_Conventional;
model StrategyController_Conventional
...
end StrategyController_Conventional;
