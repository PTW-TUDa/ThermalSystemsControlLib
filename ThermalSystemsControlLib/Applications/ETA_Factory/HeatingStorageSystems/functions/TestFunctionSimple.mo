...
createPlot(id=1, position={0, 0, 1004, 431}, y={"ramp.y", "layeredStorage_Physical_simple.valveLinear1.opening",
"layeredStorage_Physical_simple.valveLinear.opening", "layeredStorage_Physical_simple.valveLinear2.opening"}, range={0.0, 200.0, -0.1, 1.1}, grid=true, legends={"Feed temperature", "Lower valve opening", "Middle valve opening",
...
createPlot(id=2, position={329, 0, 590, 365}, y={"layeredStorage_Physical_simple.vol_temperature_upper.T", "layeredStorage_Physical_simple.vol_temperature_mid.T",
 "layeredStorage_Physical_simple.vol_temperature_lower.T", "ramp.y"}, heading="Temperature ", range={0.0, 200.0, 10.0, 110.0}, grid=true, legends={"Upper temperature", "Middle temperature", "Lowest temperature",
