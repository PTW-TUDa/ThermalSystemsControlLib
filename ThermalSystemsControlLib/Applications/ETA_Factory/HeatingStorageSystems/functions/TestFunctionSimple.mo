...
createPlot(id=1, position={0, 0, 691, 361}, y={"ramp.y", "layeredStorage_Physical.valveLayers[1].opening", "layeredStorage_Physical.valveLayers[3].opening",
 "layeredStorage_Physical.valveLayers[5].opening", "layeredStorage_Physical.valveLayers[2].opening",
 "layeredStorage_Physical.valveLayers[4].opening", "layeredStorage_Physical.valveLayers[6].opening",
 "layeredStorage_Physical.valveLayers[7].opening"}, heading="Feed valves opening", range={0.0, 10000.0, -0.1, 1.1}, grid=true, legends={"Feed temperature", "Valve opening 1 (lower)", "Valve opening 3",
...
createPlot(id=2, position={469, -8, 572, 372}, y={"ramp.y", "layeredStorage_Physical.vol_temperature[1].T", "layeredStorage_Physical.vol_temperature[2].T",
