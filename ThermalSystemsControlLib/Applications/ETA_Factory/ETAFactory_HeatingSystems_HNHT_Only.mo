...
model ETAFactory_HeatingSystems_HNHT_Only "Using full strategy for hnht"
  ...
  Modelica.Blocks.Interfaces.RealInput T_ambient "Connector of Real input signal" annotation (Placement(transformation(
        extent={{-20,-20},{20,20}},
        rotation=90,
        origin={-10,-120})));
equation
  ...
  connect(Ambient.T_ambient, T_ambient) annotation (Line(points={{-10,-42},{-10,-120}}, color={0,0,127}));
