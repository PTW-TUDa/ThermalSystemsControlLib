...
model ETAFactory_HeatingSystems
  ...
  ThermalSystemsControlLib.Applications.ETA_Factory.ThermalNetworks.HNLT HNLT(T_start_ActiveStorage=308.15)
                                                                              annotation (Placement(transformation(extent={{0,0},{20,20}})));
  ThermalSystemsControlLib.Applications.ETA_Factory.Strategies.BaseStrategyController Strategy annotation (Placement(transformation(extent={{0,60},{20,80}})));
