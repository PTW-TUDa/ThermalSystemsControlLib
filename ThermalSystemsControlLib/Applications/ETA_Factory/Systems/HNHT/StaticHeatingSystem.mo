...
model StaticHeatingSystem
  ...
  Components.Pipes.PhysicalModels.PressureDrop pressureDrop(
    ...
    m_flow_nominal=0.15)                                    annotation (Placement(transformation(
        ...
        rotation=0,
        origin={70,70})));
  Components.HeatMeter.HeatMeter WMZ350 annotation (Placement(transformation(extent={{60,100},{80,120}})));
  ...
  Modelica.Blocks.Sources.RealExpression realExpression(y=100)
                                                             annotation (Placement(transformation(extent={{42,4},{52,18}})));
...
equation
  ...
  connect(WMZ350.port_a, pressureDrop.port_b) annotation (Line(points={{80,100},{80,80}}, color={0,127,255}));
