...
model CHP1System
  ...
  Components.CombinedHeatPower.CHP CHP(
    ...
    k=5,
    yMin=0.5,
    redeclare ThermalSystemsControlLib.Applications.ETA_Factory.Records.ViessmannVitobloc200_EM_6_15 deviceData) annotation (Placement(transformation(extent={{60,-8},{80,12}})));
