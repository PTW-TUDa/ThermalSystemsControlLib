...
model OuterCapillaryTubeMatsSystem
  ...
  Components.Consumer.PhysicalModels.Consumer_ThermalResistanceOnly OuterCapillaryTubeMats(
    ...
    R_Wall=0.005) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={-10,-30})));
  Modelica.Thermal.HeatTransfer.Sources.PrescribedTemperature prescribedTemperature annotation (Placement(transformation(extent={{-60,-40},{-40,-20}})));
...
equation
  ...
  connect(OuterCapillaryTubeMats.port_b,RV600. port_a) annotation (Line(points={{-10,-20},{-10,94},{60,94},{60,80}}, color={0,127,255}));
  connect(prescribedTemperature.T, fAmbientTemperature) annotation (Line(points={{-62,-30},{-120,-30}}, color={0,0,127}));
  connect(prescribedTemperature.port,OuterCapillaryTubeMats. port_ambient) annotation (Line(points={{-40,-30},{-20.6,-30}}, color={191,0,0}));
