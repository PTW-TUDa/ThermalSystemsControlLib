...
model CondensingBoilerSystem
  ...
  Components.Valves.TwoWayValve SV331(redeclare ThermalSystemsControlLib.Applications.ETA_Factory.Records.Belimo_R2020_S2 deviceData) annotation (Placement(transformation(extent={{60,-100},{80,-80}})));
...
equation
  ...
  connect(integerExpression.y, CondensingBoiler.nControlModeAutomatic) annotation (Line(points={{1,-10},{58,-10},{58,-3}}, color={255,127,0}));
  ...
  connect(WMZ331.fHeatFlowRate, SV331.fThermalPowerExternal) annotation (Line(points={{59,-60},{76,-60},{76,-102},{70,-102}}, color={0,0,127}));
  connect(RV331.fThermalPowerExternal,SV331. fThermalPowerExternal) annotation (Line(points={{75.2,-42},{76,-42},{76,-102},{70,-102}}, color={0,0,127}));
  connect(PU.fThermalPowerExternal, SV331.fThermalPowerExternal) annotation (Line(points={{70,48},{70,60},{76,60},{76,-102},{70,-102}}, color={0,0,127}));
  ...
  connect(RV331.port_a1, pipe2.port_b) annotation (Line(points={{80,-30},{104,-30},{104,20}}, color={0,127,255}));
  connect(pipe2.port_a, PU.port_b) annotation (Line(points={{104,40},{104,70},{80,70}}, color={0,127,255}));
  connect(pipe1.port_a, CondensingBoiler.port_b) annotation (Line(points={{80,20},{80,12}}, color={0,127,255}));
