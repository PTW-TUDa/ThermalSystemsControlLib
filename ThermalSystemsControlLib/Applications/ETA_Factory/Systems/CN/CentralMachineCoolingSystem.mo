...
equation
  ...
  connect(ConsumerTemperature.Kelvin, CentralMachineCooling.T_Consumer) annotation (Line(points={{54.6,17},{87,17},{87,11}}, color={0,0,127}));
  connect(PU100.fOperatingPoint, selectSetPoint.fOperatingPoint) annotation (Line(points={{70,-19},{70,-14},{0,-14},{0,0},{-70,0},{-70,18}}, color={0,0,127}));
