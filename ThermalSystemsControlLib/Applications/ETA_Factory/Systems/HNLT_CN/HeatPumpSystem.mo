...
equation
  ...
  connect(selectSetPoint.fSetPoint, HeatPump.fSetPointAutomatic) annotation (Line(points={{-59,30},{2,30},{2,1},{58,1}}, color={0,0,127}));
  ...
  connect(systemFlowControl.bSetStatusOn_Components[2], PU_int_CN.bSetStatusOnAutomatic) annotation (Line(points={{-19,70},{20,70},{20,75},{38,75}}, color={255,0,255}));
  connect(systemFlowControl.bSetStatusOn_Components[1], SV246.bSetStatusOnAutomatic) annotation (Line(points={{-19,70},{20,70},{20,39},{78,39}}, color={255,0,255}));
  connect(SV146.bSetStatusOnAutomatic, systemFlowControl.bSetStatusOn_Components[1]) annotation (Line(points={{38,-39},{38,-38},{20,-38},{20,70},{-19,70}}, color={255,0,255}));
  connect(HeatPump.bSetStatusOnAutomatic, systemFlowControl.bSetStatusOn_Components[2]) annotation (Line(points={{58,-7},{20,-7},{20,70},{-19,70}}, color={255,0,255}));
  ...
  connect(HeatPump.bStatusOn, systemFlowControl.bStatusOn_Components[2]) annotation (Line(points={{65,-9},{65,120},{-30,120},{-30,81}}, color={255,0,255}));
  connect(HeatPump.bStatusOn, selectControlMode.bStatusOn) annotation (Line(points={{65,-9},{65,120},{-30,120},{-30,100},{-70,100},{-70,82}}, color={255,0,255}));
  connect(SV246.bStatusOn, systemFlowControl.bStatusOn_Components[1]) annotation (Line(points={{85,41},{85,120},{-30,120},{-30,81}}, color={255,0,255}));
