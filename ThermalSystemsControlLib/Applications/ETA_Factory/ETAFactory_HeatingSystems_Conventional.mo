...
model ETAFactory_HeatingSystems_Conventional
  ...
  Strategies.Strategy_Conventional.StrategyController_Conventional Strategy annotation (Placement(transformation(extent={{0,60},{20,80}})));
...
end ETAFactory_HeatingSystems_Conventional;
