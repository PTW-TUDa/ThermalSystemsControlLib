...
model HNHT_HNLT
  ...
  Systems.HNHT_HNLT.HeatPump1System HeatPump1System annotation (Placement(transformation(extent={{-40,-10},{-60,10}})));
...
equation
  ...
  HeatPump1System.bSetStatusOnAutomatic = controlAutomatic.bSetStatusOn_HeatPump;
  HeatPump1System.bAlgorithmPermission = controlAutomatic.bAlgorithmPermission_HNHT and controlAutomatic.bAlgorithmPermission_HNLT;
  HeatPump1System.fSetPointAutomatic = controlAutomatic.fFeedTemperature_HNHT;
  ...
  connect(HeatPump1System.port_a1, pipe4.port_b) annotation (Line(points={{-56,10},{-56,20},{-20,20}}, color={0,127,255}));
