...
model HNLT_CN
  ...
  Systems.HNLT_CN.HeatPump2System HeatPump2System annotation (Placement(transformation(extent={{80,-12},{60,8}})));
...
equation
  ...
  connect(HeatPump2System.port_a1, pipe5.port_b) annotation (Line(points={{64,8},{64,40},{80,40}}, color={0,127,255}));
  connect(pipe5.port_a, port_a_CN_Producer) annotation (Line(points={{100,40},{100,60}},        color={0,127,255}));
  connect(HeatPump2System.port_b1, pipe6.port_a) annotation (Line(points={{64,-12},{64,-20},{80,-20}}, color={0,127,255}));
  ...
  connect(pipe4.port_a, HeatPump2System.port_b2) annotation (Line(points={{60,40},{60,8}}, color={0,127,255}));
  connect(pipe7.port_b, HeatPump2System.port_a2) annotation (Line(points={{60,-20},{60,-12}}, color={0,127,255}));
