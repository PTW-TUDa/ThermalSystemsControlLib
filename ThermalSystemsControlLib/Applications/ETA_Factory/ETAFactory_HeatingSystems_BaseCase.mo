...
model ETAFactory_HeatingSystems_BaseCase
  extends ThermalSystemsControlLib.BaseClasses.Icons.Applications_Icon;
  ThermalSystemsControlLib.Applications.ETA_Factory.ThermalNetworks.HNHT HNHT annotation (Placement(transformation(extent={{-42,0},{-22,20}})));
  ...
  ThermalSystemsControlLib.Applications.ETA_Factory.Strategies.BaseStrategyController Strategy annotation (Placement(transformation(extent={{-4,50},{16,70}})));
...
end ETAFactory_HeatingSystems_BaseCase;
